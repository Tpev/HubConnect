<div class="mx-auto max-w-3xl w-full" 
    ...
    <div class="bg-white shadow rounded-2xl overflow-hidden">
        <div class="px-5 py-4 border-b flex items-center justify-between">
            ...
            {{-- Quick access to other company profile --}}
            @if($other)
        ...
        <div wire:poll.2s="tick" class="p-5 space-y-4 max-h-[60vh] overflow-y-auto" id="dealroom-scroll">
            @forelse($room->messages as $msg)
                @php
                    ...
                    // Label policy: You (mine), else user name if set, else company name, else "Partner"
...
@push('scripts')
<script>
    // Keep scrolled to bottom after Livewire DOM updates
